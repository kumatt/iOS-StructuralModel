...
@interface BaseTransformDetailViewController ()<PTPublicPageRouterDelegate,PublicPageMagicTransformDelegate,UIViewControllerTransitioningDelegate,UINavigationBarDelegate>
...
- (void)router_setParamentDict:(NSDictionary *)dict
{
    ...
    NSUInteger select_id = [dict[@"id"] integerValue];
