...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    switch (indexPath.row) {
        case 0:
            [PublicPageRouter OpenUrlWithModalType:PublicPageRouterModuleTransformMagic DataEntity:nil Animated:YES];
            break;
        case 3:
            [PublicPageRouter OpenUrlWithModalType:PublicPageRouterModuleTransformCircleSpread DataEntity:nil Animated:YES];
        default:
            break;
    }
}
