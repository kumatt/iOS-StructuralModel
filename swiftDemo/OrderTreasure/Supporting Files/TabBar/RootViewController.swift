...
class RootViewController: UITabBarController {
    ...
    func create_itemsData()-> Array<Dictionary<String,String>> {
        ...
        itemsArray.append([key_title:"桌台",key_class:"OrderTreasure.BaseBarViewController",key_normalImage:"dian-can-nomal",key_selectImage:"dian-can-click"])
        itemsArray.append([key_title:"订单",key_class:"OrderTreasure.BaseOrderViewController",key_normalImage:"ding-dan-nomal",key_selectImage:"ding-dan-click"])
        itemsArray.append([key_title:"个人",key_class:"OrderTreasure.BaseAcctViewController",key_normalImage:"ge-ren--nomal",key_selectImage:"ge-ren--click"])
        return itemsArray
    }
    ...
    func add_childController() {
        for dict in self.create_itemsData() {
            ...
            naVc.navigationBar.tintColor = color_backGround
    ...
    func hook_viewController(viewController:UIViewController) {
        ...
        do {
            try UIViewController.aspect_hook(#selector(UIViewController.viewWillAppear(_:)), with: AspectOptions.positionBefore, usingBlock: block_viewWillAppear as AnyObject)
        } catch  {
            print(error)
        }
        ...
        do {
            try UIViewController.aspect_hook(#selector(UIViewController.viewWillDisappear(_:)), with: AspectOptions.positionBefore, usingBlock: block_viewWillDisAppear as AnyObject)
        } catch  {
            print(error)
        }
    }
